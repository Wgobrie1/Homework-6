function initPage() {
    // Obtaining elements in order to be used later in the JS code
    ...
    let searchHistory = JSON.parse(localStorage.getItem("search")) || []; // If localStorage is empty for this particular item, create blank array
    console.log(searchHistory);
    const APIKey = "d2f64e325c35ff7f75b1d11500e4dbf5"; 
    ...
    // Adding an event listener for the search button, next to the search bar
    ...
    // Function to listen for click, and to then clear the search history on click
    clearEl.addEventListener("click",function() {
        searchHistory = [];
        renderSearchHistory();
    })
    // Function to convert Kelvin temperatures to Celcius 
    function k2c(K) { 
